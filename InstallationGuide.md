...
## Currently Supported Game Version: 2.0.5 - Exclusively works with Steam Installation only!
...
4.  Select the Borscht.wabbajack file you downloaded from NexusMods
